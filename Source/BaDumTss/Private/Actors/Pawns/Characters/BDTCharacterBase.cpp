...
Super(ObjectInitializer.SetDefaultSubobjectClass<UBDTCharacterMovementComponent>(CharacterMovementComponentName))
{
    ...
    InvulnerableToDamageTag = FGameplayTag::RequestGameplayTag(FName("State.Invulnerable.Damage"));
...
void ABDTCharacterBase::BeginPlay()
{
	...
	if (IsValid(AbilitySystemComponent))
	{
		...
		AbilitySystemComponent->GetGameplayAttributeValueChangeDelegate(PrimaryAttributeSet->GetHealthAttribute()).AddUObject(this, &ABDTCharacterBase::OnHealthChangedInternal);
...
void ABDTCharacterBase::OnHealthChangedInternal(const FOnAttributeChangeData& Data)
{
