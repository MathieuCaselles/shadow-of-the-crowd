...
#include "BDTAT_PlayMontageAndWaitForEvent.generated.h"

class UBDTAbilitySystemComponent;

/** Delegate type used, EventTag and Payload may be empty if it came from the montage callbacks */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FBDTPlayMontageAndWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
 ...
 */
UCLASS()
class BADUMTSS_API UBDTAT_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

	public:
	// Constructor and overrides
	UBDTAT_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	FBDTPlayMontageAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FBDTPlayMontageAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FBDTPlayMontageAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FBDTPlayMontageAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FBDTPlayMontageAndWaitForEventDelegate EventReceived;
	...
	static UBDTAT_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
...
private:
	...
	UBDTAbilitySystemComponent* GetTargetASC();
