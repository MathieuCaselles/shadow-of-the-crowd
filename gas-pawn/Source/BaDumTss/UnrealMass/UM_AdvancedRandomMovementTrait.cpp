...
void UM_AdvancedRandomMovementTrait::BuildTemplate(FMassEntityTemplateBuildContext& BuildContext, const UWorld& World) const
{
	BuildContext.AddTag<FNPC>();
}

UUM_AdvancedRandomMovementProcessor::UUM_AdvancedRandomMovementProcessor()
{
...
void UUM_AdvancedRandomMovementProcessor::Execute(FMassEntityManager& EntitySubsystem, FMassExecutionContext& Context)
{
...
void UUM_AdvancedRandomMovementProcessor::ConfigureQueries()
{
