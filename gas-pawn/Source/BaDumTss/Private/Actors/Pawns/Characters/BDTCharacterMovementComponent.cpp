...
FNetworkPredictionData_Client * UBDTCharacterMovementComponent::GetPredictionData_Client() const
{
	check(PawnOwner != NULL);

	if (!ClientPredictionData)
	{
		UBDTCharacterMovementComponent* MutableThis = const_cast<UBDTCharacterMovementComponent*>(this);
