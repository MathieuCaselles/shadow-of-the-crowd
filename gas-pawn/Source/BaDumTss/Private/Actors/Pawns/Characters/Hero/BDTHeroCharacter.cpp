...
void ABDTHeroCharacter::BeginPlay()
{
	...
	if (IsValid(AbilitySystemComponent))
		AbilitySystemComponent->GetGameplayAttributeValueChangeDelegate(PrimaryAttributeSet->GetHealthAttribute()).AddUObject(this, &ABDTHeroCharacter::OnHealthChanged);
...
void ABDTHeroCharacter::OnHealthChanged(const FOnAttributeChangeData& Data)
{
